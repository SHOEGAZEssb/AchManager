...
namespace AchManager.AchievementTrigger
{
  ...
  internal sealed class MarkKilledTriggerConfigWindow(MarkKilledTriggerConfig config, string name, ImGuiWindowFlags flags = ImGuiWindowFlags.None, bool forceMainWindow = false)
